...
**Phase 1 — Vertical slice: Negotiation, Aggressor, playbook mode, text only (1.5 days)**
...
**Phase 2 — The standard, grounded in the graph (1.5 days)**
...
**Phase 2.5 — SECV citation verifier (1 day) — the differentiator**
...
**Phase 3 — Memory + adaptivity + breadth (1 day)**
